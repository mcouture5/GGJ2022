...
export class GameScene extends Phaser.Scene {
    ...
    create(): void {
        ...
        this.truck = this.add.sprite(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2, 'truck').setOrigin(0.5, 0.5)
            .setPosition(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2);

        this.truckTire1 = this.add.sprite(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2, 'tire').setOrigin(0.5, 0.5)
            .setPosition(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2);

        this.truckTire2 = this.add.sprite(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2, 'tire').setOrigin(0.5, 0.5)
            .setPosition(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2);

        this.trailer = this.add.sprite(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2, 'trailer').setOrigin(0.5, 0.5)
            .setPosition(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2);

        this.trailerTire1 = this.add.sprite(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2, 'trailertire').setOrigin(0.5, 0.5)
            .setPosition(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2);

        this.trailerTire2 = this.add.sprite(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2, 'trailertire').setOrigin(0.5, 0.5)
            .setPosition(DISPLAY_SIZE.width / 2, DISPLAY_SIZE.height / 2);
